  ...
  return (
    <div className="fixed inset-0 z-[100] grid place-items-center p-5 max-[760px]:p-3 max-[760px]:pb-[max(12px,env(safe-area-inset-bottom))]">
      ...
      >
        ...
        <div className="max-h-[min(660px,calc(100svh-40px))] overflow-y-auto px-8 pb-[30px] pt-[52px] [scrollbar-color:#cbd3ce_transparent] [scrollbar-width:thin] max-[760px]:max-h-[calc(100svh_-_24px_-_env(safe-area-inset-bottom))] max-[760px]:px-[22px] max-[760px]:pb-[22px] max-[760px]:pt-[54px]">
