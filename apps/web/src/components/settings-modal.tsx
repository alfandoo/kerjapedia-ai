                  ...
                  <div className="border-t border-[#e8e4dc] bg-white">
                    {([
                      ...
                      <button
                        key={option.value}
                        type="button"
                        className={`flex min-h-[44px] w-full items-center px-4 text-left text-[13px] transition hover:bg-[#f0f2f0] ${
                          index === 2 ? "rounded-b-2xl" : ""
                        } ${theme === option.value ? "font-semibold text-tinta bg-[#f0f2f0]" : "text-muted-text"}`}
                        onClick={() => {
                  ...
                  <div className="border-t border-[#e8e4dc] bg-white">
                    {([
                      ...
                      <button
                        key={option.value}
                        type="button"
                        className={`flex min-h-[44px] w-full items-center px-4 text-left text-[13px] transition hover:bg-[#f0f2f0] rounded-b-2xl ${
                          language === option.value ? "font-semibold text-tinta bg-[#f0f2f0]" : "text-muted-text"
                        }`}
                        onClick={() => {
