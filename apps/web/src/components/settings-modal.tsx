            ...
            <div className="space-y-5">
              ...
              <div className="rounded-2xl border border-[#e5e5e5] bg-[#f7f7f8]">
                ...
                >
                  ...
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`size-4 text-[#676767] transition-transform ${appearanceOpen ? "rotate-180" : ""}`}>
                    <path d="M6 9l6 6 6-6" />
                  </svg>
                </button>
                {appearanceOpen ? (
                ...
                >
                  ...
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`size-4 text-[#676767] transition-transform ${languageOpen ? "rotate-180" : ""}`}>
                    <path d="M6 9l6 6 6-6" />
                  </svg>
                </button>
                {languageOpen ? (
                    ...
                    {([
                      ...
                      <button
                        ...
                        className={`flex min-h-[44px] w-full items-center px-4 text-left text-[13px] transition hover:bg-[#ececec] rounded-b-2xl ${
                          language === option.value ? "font-semibold text-tinta bg-[#ececec]" : "text-muted-text"
                        }`}
                        onClick={() => {
              ...
              <div className="rounded-2xl border border-[#e5e5e5] bg-[#f7f7f8]">
                ...
                >
                  ...
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="size-4 text-[#676767]">
