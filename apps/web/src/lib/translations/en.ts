const en = {
  ...
  "auth.otpTitle":
    "Verification code: We sent a verification code to {email}. Enter the code to complete your registration.",
  "auth.otpHint":
  ...
  "auth.otpInvalid": "The verification code is invalid or expired.",
