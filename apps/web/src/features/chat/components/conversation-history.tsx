...
export function ConversationHistory({
  ...
  return (
    <section
      ...
      className={cn(
        "min-w-0 border-r border-sidebar-border bg-sidebar px-2 pb-3 pt-2 text-sidebar-foreground",
            ...
            {conversations.map((item) => {
              ...
              return (
                <li
                  ...
                  className="chat-history-row group relative transition-colors hover:bg-sidebar-accent focus-within:bg-sidebar-accent [content-visibility:auto] [contain-intrinsic-size:auto_32px]"
                >
                  {isEditing ? (
                    <form
                    ...
                    <div className="grid grid-cols-[minmax(0,1fr)_32px] items-center">
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button
                            ...
                            variant="ghost"
                            size="icon"
                            className="size-8 border-0 shadow-none opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 data-[state=open]:opacity-100 max-[760px]:opacity-100"
