...
export function ConversationHistory({
  ...
  return (
    ...
    >
      <h2 className="mb-5 font-display text-lg font-semibold text-tinta">
      ...
      <div
        className="mt-[22px] min-h-0 flex-1 overflow-y-auto"
              ...
              <>
                ...
                >
                  ...
                  <span className="min-w-0">
                    <strong className="block truncate text-xs font-semibold">{item.title}</strong>
